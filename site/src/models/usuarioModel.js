...
function atualizarCaixa(idFuncionario, nomeFuncionario, emailFuncionario, senhaFuncionario) {
    console.log("ACESSEI O AVISO MODEL \n \n\t\t >> Se aqui der erro de 'Error: connect ECONNREFUSED',\n \t\t >> verifique suas credenciais de acesso ao banco\n \t\t >> e se o servidor de seu BD está rodando corretamente. \n\n function deletarCaixa():", idFuncionario);
    var instrucao = `
        UPDATE funcionario SET emailFuncionario = '${emailFuncionario}', 
        nomeFuncionario = '${nomeFuncionario}', senhaFuncionario = '${senhaFuncionario}'
