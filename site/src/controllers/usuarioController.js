...
function editarCaixa(req, res) {
    ...
    var senhaFuncionario = req.params.senhaFuncionario;

    usuarioModel.editarCaixa(idFuncionario, nomeFuncionario, emailFuncionario, senhaFuncionario)
        .then(
            function (resultado) {
                res.json(resultado);
            }
